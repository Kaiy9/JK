...
export const NAV_DATA: NavData[] = [
  {
    ...
    items: [
      ...
      {
        icon: 'http://www.88kanqiu.love/storage/images/d0170ac257b781a7d9510c4c918e9e0c.svg',
        title: '88看球',
        desc: '免费看球的网站',
        link: 'http://www.88kanqiu.love/',
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        title: 'manus',
        desc: 'manus 的自动机器人',
        link: 'https://manus.im/login?code=Q8ZFSCLPVCFULHA&type=signUp',
      },
      {
        icon: 'https://gemini.google.com/logo.svg',
        title: 'Gemini',
        desc: '白嫖只能支持了 干翻gpt',
    ...
    },
    {
        ...
        desc: 'AI 驱动，快速生成演示文稿和网页'
    },
    {
        icon: 'https://claude.ai/favicon.ico',
        title: 'Claude',
        link: 'https://claude.ai',
        desc: 'Anthropic 公司的大型语言模型，代码辅助能力强'
    },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      {
        icon: 'https://fast.com/favicon.ico',
        title: 'Fast',
        desc: '奈飞的简单网速测试',
        link: 'https://fast.com',
      },
      ...
      {
        icon: 'https://ipcheck.ing/favicon.ico',
        title: 'IPCheck',
    ...
    items: [
      ...
      link: 'https://squoosh.app/'
            ...
            },
            {
                ...
                title: 'CSS渐变2',
                desc: '180种免费的线性渐变,不仅可以复制渐变的原生CSS颜色代码还可以查看下载每个优质的渐变图片',
